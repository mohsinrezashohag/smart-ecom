                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img01.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img02.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                  ...
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href={`/pro/${`One Washer Dryer Combo`}`}>
                        <img
                          src="/assets/client_assests/img/product/shop_img03.png"
                          alt="img"
                        />
                      </Link>{" "}
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img04.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img05.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img06.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img07.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img08.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-8">
                  <div className="shop-product-item mb-30">
                    <div className="shop-thumb">
                     <Link href="/pro/hello-product">
                        <img
                          src="/assets/client_assests/img/product/shop_img09.png"
                          alt="img"
                        />
                      </Link>
                      <span>New</span>
