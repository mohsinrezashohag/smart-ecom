                ...
                <div className="tab-content" id="nav-tabContent">
                  ...
                  >
                    <div className="shop-details-img">
                      <img
                        src="/assets/client_assests/img/product/shop_details01.jpg"
                        alt="img"
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="shop-details-img">
                      <img
                        src="/assets/client_assests/img/product/shop_details02.jpg"
                        alt="img"
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="shop-details-img">
                      <img
                        src="/assets/client_assests/img/product/shop_details03.jpg"
                        alt="img"
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="shop-details-img">
                      <img
                        src="/assets/client_assests/img/product/shop_details04.jpg"
                        alt="img"
                      />
                    </div>
                  </div>
              ...
              <div className="shop-details-nav-wrap">
                <nav>
                  <div className="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    >
                      <img
                        src="/assets/client_assests/img/product/shop_nav_img01.jpg"
                        alt="img"
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="/assets/client_assests/img/product/shop_nav_img02.jpg"
                        alt="img"
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="/assets/client_assests/img/product/shop_nav_img03.jpg"
                        alt="img"
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="/assets/client_assests/img/product/shop_nav_img04.jpg"
                        alt="img"
                      />
                    </button>
                  </div>
